...
if ($user) {
    ...
    $appt_sql = "SELECT bookID, Clinic_Name, Service, date, Time_Slot FROM bookings WHERE Id_number = ? ORDER BY date DESC, Time_Slot DESC";
    ...
    <div class="container">
        <header class="top-header">
            ...
            <div class="user-section">
                <span class="user-name"><i class='bx bxs-user'></i> <?php echo htmlspecialchars($name . ' ' . $surname); ?></span>
